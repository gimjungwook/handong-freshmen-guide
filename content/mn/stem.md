...
- **AI & Computer Engineering**: Программ хангамж, Хиймэл оюун ухаан, Өгөгдлийн шинжлэх ухаан, Кибер аюулгүй байдал
- **Computer & Electronic Engineering**: Компьютерийн инженерчлэл, Электроникийн инженерчлэл, Суулгасан систем
- **Mechanical & Control Engineering**: Механик инженерчлэл, Роботик, Удирдлагын систем
- **Spatial Environment & Systems Engineering**: Барилга, Байгаль орчин, Хотын инженерчлэл
- **Life Sciences**: Биологи, Биотехнологи, Биоинженерчлэл

"Яг ямар мэргэжил гэдгээ мэдэхгүй ч STEM хүн гэдгээ мэднэ" гэж бодож байгаа ч бай — энэ гарын авлага танд зориулагдсан. Хандон-д эхний жилдээ мэргэжлээ сонгодоггүй. Энэ нь гол стратеги нь **эцэст нь аль STEM мэргэжлийг сонгосон ч хэрэг болох суурь хичээлүүдээр эхний жилээ дүүргэх** гэсэн үг.

### 💡 Яагаад эхний жилийн суурь ийм чухал вэ

STEM хичээлүүд нь **шатны** адил бүтэцтэй. Calculus-гүйгээр Дифференциал тэгшитгэл авч чадахгүй. Дифференциал тэгшитгэлгүйгээр Удирдлагын инженерчлэлийг ойлгож чадахгүй. Linear Algebra аваагүй бол Machine Learning-ийн лекц дээр матрицын үйлдлүүд гарахад дагаж чадахгүй. Физикгүйгээр хэлхээний онол дахь Кирхгоффын хуулиуд яагаад тийм хэлбэртэй болохыг ойлгохгүй.

Өөрөөр хэлбэл, 1-р жилд математик, шинжлэх ухааны суурийг алгасвал мэргэжлийн хичээлүүд 2-р жилээс эхлээд **домино шиг нурана**. STEM-д "дараа авъя" гэдэг нь "дараа зовъя" гэж хэлж байгаатай адил.

### 🏷️ Хичээлийн кодыг хэрхэн унших вэ: Алгасаж болохгүй

Хандон-ы хичээлийн кодууд нуугдсан боловч чухал мэдээлэл агуулдаг. Жишээлбэл, `GCS10058` дотор:

- **GCS**: Тэнхим/чиглэлийн код (GCS = Global Creative Software)
- **1**0058: Эхний цифр **курсын түвшинг** заана

Яагаад чухал вэ? **1-ээр эхэлсэн хичээлүүд 1-р курсынхонд зориулагдсан; 3 эсвэл 4-ээр эхэлсэн нь ахмад оюутнуудынх.** Зарим шинэ оюутан амбицтай байж 3xxx, 4xxx хичээлд бүртгүүлэх гэж оролддог — энэ бол суурийг тавиагүйгээр байшин барьж байгаатай адил. Бүртгэлийн систем зогсоохгүй байлаа ч **эхний жилдээ 1xxx хичээлүүдэд бай.**

Мөн мэргэжлээ баталгаажуулахаас өмнө мэргэжлийн гүнзгий хичээлүүд авах нь эрсдэлтэй. Эхлээд Calculus, Физик, Програмчлал, Linear Algebra зэрэг **бүх нийтэд хамааралтай хичээлүүдийг** дүүргэх нь хамаагүй ухаалаг.
...
Calculus бол бараг бүх чиглэлийн **нийтлэг хэл**: инженерчлэл, физик, компьютерийн шинжлэх ухаан, бүр эдийн засаг ч. Дифференциалчлал нь "өөрчлөлтийн хурдтай", интеграл нь "хуримтлагдсан хэмжээтэй" холбоотой — эдгээр хоёр ойлголтгүйгээр ямар ч дэвшилтэт STEM хичээл нэвтэрч чадахгүй.

Calculus-ийг гадаад хэл сурахын **цагаан толгой** гэж бод. Цагаан толгойгүйгээр үг уншиж чадахгүй, үггүйгээр өгүүлбэр ойлгож чадахгүй. Ахлах сургуульд математикдаа сайн байсан ч, муу байсан ч хамаагүй — их сургуулийн Calculus бол гүнзгийрлийн үндсээрээ өөр түвшин. Эпсилон-дельта тодорхойлолтоос эхлэн хатуу математик сэтгэлгээнд суралцана.

**Тохиромжтой зам**: 1-р улирал Calculus 1 → 2-р улирал Calculus 2 → 3-р улирал Дифференциал тэгшитгэл. Хэрэв энэ дараалал нэг улирал ч хойшлогдвол мэргэжлийн хичээлд орох хугацаа хоцорно.
...
- **Солонгос хэлээр суралцах чадвартай бол**: Section 01 (Lee Hanjin, Mon P4 / Thu P4) эсвэл Section 02 (Lee Hanjin, Mon P6 / Thu P6). Ижил багш, зүгээр өөр цаг.
- **Англи хэлээр заалгах шаардлагатай бол**: **Section 03 (Kim Minjae) эсвэл Section 04 (Cho Janghwan)**. Гэхдээ Section 04 нь **Period 1 (9:00 AM)**. Эхний улиралдаа дасан зохицож байх үед сонголт байвал Period 1-ээс зайлсхийх нь ухаалаг. Мэдээж заавал шаардлагатай хичээлийн хувьд цор ганц хувилбар бол авна — гэхдээ хувилбар байвал Period 2 эсвэл түүнээс хойш хуваарилаарай.

> **⚠️ "Англи лекц" алдаа**: Ижил багшийн ч гэсэн өөр өөр ангиуд өөр хэлээр заагдаж болно. Анги бүрийн лекцийн хэлийг заавал шалгаарай. Хэрэв солонгос хэл чинь хангалтгүй бол солонгос ангид орвол математик ба хэлний саадтай зэрэг тэмцэх болно. Эсрэгээр ч мөн адил — бүртгүүлэхийн өмнө шалгаарай.

### 🔢 2.2 Calculus 2 — Чадвал 1-р улиралд аваарай

Ихэвчлэн Calculus 2-ийг 2-р улиралд авдаг, гэхдээ ахлах сургуулиас хүчтэй calculus-ын суурьтай бол 1-р улиралд Calculus 1, 2-ыг зэрэг авах боломжтой. Ингэснээр Дифференциал тэгшитгэлийг 2-р улирлаас эхлэн авч, мэргэжлийн хичээлд орох хугацааг бүхэл улирлаар хурдасгаж болно.

Гэхдээ энэ нь **математикийн чадвардаа үнэхээр итгэлтэй бол л санал болгоно**. Нэг хичээлийг бат сайн суралцах нь хоёулангийг нь хэт ачаалж, хоёуланг нь алдахаас дээр.
...
**Physics 1 vs. Introduction to Physics**: Хэрэв Computer Science эсвэл AI бодож байгаа бол оронд нь "Introduction to Physics" (물리학 개론) авч болно. Physics 1-ээс өргөн хүрээг хамарч, гэхдээ гүн бус — инженерийн мэдрэмж бий болгоход хангалттай. Гэхдээ Electronic Engineering эсвэл Mechanical Engineering-г бодож байгаа бол, физик мэргэжилтэй гүнзгий холбогдсон тул **Physics 1-ийг эргэлзэлгүй аваарай.**
...
Calculus 1-тэй зэрэг 1-р улиралд авахыг хүчтэй санал болгоно. Хэцүү байна, гэхдээ хоёуланг нь эхний улиралд дуусгавал 2-р улирлаас эхлэн сонголтуудыг **тэсрэхийн адил өргөжүүлнэ**.
...
Хандон-д бүх оюутан **ICT Convergence Fundamentals-ийн 7 кредит** дуусгах ёстой: 5 кредит програмчлал + 2 кредит хэрэглээний ICT. STEM оюутнуудын хувьд програмчлал бол зүгээр нэг ерөнхий боловсролын шаардлага биш — энэ бол **мэргэжлийн хэрэгсэл.**

**Яагаад 1-р жилд програмчлалыг дуусгах ёстой вэ**: 2-р жилээс мэргэжлийн хичээлүүдээс програмчлалын даалгаврууд цутгаж эхэлнэ. Тэр үед суурь програмчлалын хичээл авч байвал цаг алдалт ноцтой байна. Тохиромжтой нь 1-р улиралд 3 кредитийн програмчлалын хичээл (Python/C) авч, үлдсэнийг 2-р улиралд дуусгах.
...
AI эсвэл Data Science таны зам бол Python-оос эхлэх нь бүрэн зүгээр. Практикт хамгийн өргөн хэрэглэгддэг хэл бөгөөд доод босго нь програмчлалын баярыг эхлээд мэдрүүлнэ.
...
> **Intro to Frontend (GCS10081) — 3 кредит, вэб хөгжүүлэлтэд сонирхолтой хүмүүст:**
...
Intro to Frontend нь вэб хөгжүүлэлтийн үндсийг хамарна — HTML, CSS, JavaScript. 2 кредитийн ICT хэрэглээний шаардлагад тооцогдох, эсвэл 3 кредитийн програмчлалын хичээл болж тооцогдох боломжтой. Вэб хөгжүүлэлтэд сонирхолтой бол авч болно.
...
General Biology нь Life Sciences-д орохын тулд хэрэгтэй, гэхдээ сонсох ёстой нэг **шударга бодит байдал** бий.

**⚠️ General Biology-ийн өрсөлдөөн маш хүчтэй.** Анги цөөн, дахин авч буй оюутнууд болон ахмад оюутнууд ихэвчлэн суудал эхлээд эзэлдэг тул **шинэ оюутнууд 1-р улиралд бүртгүүлэхэд маш хэцүү.** "1-р улиралд заавал авах ёстой" гэж зөрүүдлэн, бусад чухал хичээлийн бүртгэлийн цонхыг алдахын оронд, **хамаагүй ухаалаг стратеги** бол уян хатан байх: суудал гарвал авч, гарахгүй бол 2-р улиралд хойшлуулах.
...
AI & Computer Engineering эсвэл Computer & Electronic Engineering тэнхимд сонирхолтой бол энэ оршил хичээл нь чиглэлийн ерөнхий дүр зургийг өгнө. "Энэ чиглэл надад тохирох уу" гэдгийг мэргэжлийн хичээлд бүрэн орохоос өмнө олж мэдэх сайн арга.
...
## 🗓️ 3. Санал болгох хуваарь

Доорх нь 2026 хаврын бодит хичээлийн санал дээр суурилсан **жишиг хуваарь**. Эдгээр нь зөвхөн жишиг жишээнүүд — EPT (English Placement Test) үр дүн, сонирхлын чиглэл, тэсвэр тэвчээрт тохируулан тохируулаарай.

**Гол зарчим: Илүү олон хичээлд бүртгүүлээд зарим нь хасах нь, цөөн хичээлд бүртгүүлээд харамсахаас дээр.** Бөөнөөр бүртгүүлж, эхний долоо хоногт хичээлд сууж, зохицуулж чадахгүйгээ хасаарай. Эсрэгээр — засах хугацаанд алдартай хичээл нэмэх гэх нь бараг боломжгүй, учир нь нээлттэй суудал ховор.
...
Calculus 1-ийг 2-р улиралд хойшлуулбал → Calculus 2 3-р улиралд → Дифференциал тэгшитгэл 4-р улиралд → Мэргэжлийн гол хичээлүүд зөвхөн 5-р улирлаас хүртээмжтэй болно. Энэ нь төгсөлтийг бүхэл жилээр хойшлуулж болно. **Математикийг 1-р улиралд эхлүүл, ямар ч үл хамааран.**
...
Ижил хичээл, ижил багшийн хувьд ч **лекцийн хэл анги бүрт ялгаатай байж болно.** Жишээлбэл, Cho Janghwan багшийн Calculus 1 нь 100% англи, Lee Hanjin багшийн ангиуд солонгос. Бүртгүүлэхийн өмнө анги бүрийн лекцийн хэлийг заавал шалгаарай. Солонгос хэл чинь хангалтгүй байхад солонгос ангид орвол хичээл, хэлний саадтай зэрэг тэмцэх давхар ачаалалтай — энэ бол нэн хэцүү.

### ❌ Алдаа 6: Хэтэрхий цөөн кредит бүртгүүлэх

"Хэцүү байхаас айгаад 15 кредит бүртгүүлье" — энэ стратеги хор болно. **Илүү бүртгүүлээд хасах нь, цөөхнийг бүртгүүлээд нэмэх гэхээс хамаагүй хялбар.** Засах хугацаанд алдартай хичээлд нээлттэй суудал авах нь гайхамшигтай тэнцэнэ. 18-20 кредитээр эхлээд, эхний долоо хоногт хичээлд суугаад, зохицуулж чадахгүйгээ хасаарай. Энэ бол ухаалаг арга.
...
|--------|--------|----------------|
| **Calculus 2** | Бүх STEM | Calculus 1-ийн үргэлжлэл. Цуваа, олон хувьсагчийн calculus-ыг хамарч, Дифференциал тэгшитгэлийн урьдач шаардлага |
