...
- **AI·컴퓨터공학부**: 소프트웨어, 인공지능, 데이터사이언스, 사이버보안
- **전산전자공학부**: 컴퓨터공학, 전자공학, 임베디드시스템
- **기계제어공학부**: 기계공학, 로봇공학, 제어시스템
- **공간환경시스템공학부**: 건설, 환경, 도시공학
- **생명과학부**: 생물학, 바이오, 생명공학
...
- **GCS**: 학부/영역 코드 (GCS = Global Creative Software)
...
프론트엔드입문은 HTML, CSS, JavaScript 등 웹 개발의 기초를 다루는 과목으로, ICT 응용 2학점을 채우는 데 활용할 수도 있고, 프로그래밍 3학점 과목으로 인정받을 수도 있습니다. 웹 개발에 관심이 있다면 고려해보세요.
...
|------|--------|------|----------|
| 01 | 현창기 외 | 월5, 목5 | 0% |
| 02 | Holzapfel Wilhelm 외 | 월2, 목2 | 100% |
| 03 | 현창기 외 | 월6, 목6 | 0% |

### 🤖 2.8 AI컴퓨터및전자공학입문 — 전공 맛보기

AI·컴퓨터공학부나 전산전자공학부에 관심이 있다면 이 과목을 들어보는 것도 좋습니다. 전공의 전체적인 그림을 보여주는 입문 강좌로, 본격적인 전공 수업 전에 "이 분야가 나와 맞는지" 감을 잡을 수 있어요.
