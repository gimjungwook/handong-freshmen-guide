...
Understanding Christianity (GEK20059), Christianity and Comparative Religion (GEK20065) и Christianity and Postmodernism (GEK20060) — нужно пройти **только один из трёх**. Эти три курса считаются эквивалентными (одинаковый курс), поэтому достаточно завершить любой один. **В весеннем семестре 2026 открыт только Understanding Christianity**, так что выбора нет.
...
Это требование касается **иностранных студентов**, а также **студентов, поступивших через зарубежные вступительные треки** (например, 재외국민, Global Talent, дети миссионеров), которым может быть сложно учиться на корейском. Применимость определяется типом вступительного трека, а не просто паспортом или местом проживания. Нужно пройти курс Practical Korean. Во время ориентации ты сдашь тест на определение уровня.
