...
不管你将来想读什么专业，不管你偏向理工还是人文，不管你来自哪个国家，以下课程**每位新生都必须完成**。建议先把这些课程在课表里排好，再往里填其他课程哦。

---

## Chapel 1（0学分，每学期必修）

Chapel 不计学分，但**每学期都要修**。你必须在六个学期内依次完成 Chapel 1 到 Chapel 6，否则无法毕业。

新生最常犯的 Chapel 错误是：很多同学以为不用注册就能直接去参加。**但你必须在 course registration 系统里注册 Chapel。** 每年都有学生认认真真参加了一整学期，最后才发现自己从没注册过——出勤记录一律无效。这个错误基本上无法补救，真的很可惜呀。

Chapel 签到使用 **QR码系统**。你必须准时到场并扫码。如果漏了扫码，事后补签几乎不可能。千万不要迟到嘛。

> **Spring 2026:** Chapel 1 (GEK10001), Section 01 — Wed periods 4, 5, 6 (Hyoam Main Building) / Language: Korean (0% English)

---

## Community Leadership Training 1（0.5学分，每学期必修）

和 Chapel 一样，这门课每学期都要修。它侧重于在你所在社区中的领导力培养和团队合作。**同样的注册问题在这里也会出现**——有学生整学期参加了每周的小组会议，但实际上从没在系统里注册过。所以一定要记得注册啦！

> **Spring 2026:** Community Leadership Training 1 (GEK10008), Section 01 — Time TBA (announced later)

---

## Handong Character Education（1学分，一次性要求）

这是 Handong 品格教育理念的核心课程，只需完成一次。有多个分班可选。**Section 01 全英文授课**，是国际学生的理想选择。
...
Section 02 到 06 都在周三第2节，区别只在于授课教授不同。如果你的韩语够用，可以在选课前问问你的섬김이（学长导师）了解各位教授的教学风格呀。

---

## Christian Faith Foundation (CF1) — 2学分

你需要从以下类别中选修一门课程：Understanding the Bible、Bible and Life 或 Bible and Spiritual Growth。这几门课被视为等价课程，选一门即可。

### Understanding the Bible (GEK20058) — 15个分班

这是开设分班最多的课程，共15个分班，最容易融入任何课表安排。
...
**国际学生注意**：请选 Section 07（Joshua Kim，100% English）、Section 11（최성호，100% English）或 Section 12（최성호，100% English）。英文分班很抢手，预选课阶段可能很快满员——一定要准备好备选方案呀。
...
两个分班都是全英文授课。如果 Understanding the Bible 的英文分班已满，这是一个很好的替代选择啦。

---

## Worldview — 2学分

你需要从以下类别中选修一门：Creation and Evolution、Christians and Mission 或 Christian Worldview。每门课都有韩语和英语分班。
...
**注意时间冲突：** 多门课程集中在周三第2-3节。如果你选了 Character Education 的 Section 02-06（Wed 2），就不能同时选周三第2-3节的 Worldview 课程。请仔细规划嘛。

---

## Social Service（1学分 × 共2门）

毕业前你必须完成两门社会服务课程（从 Social Service 1-4 中选），建议每学期修一门。
